...
public class Ex3Tests {
	...
	private EmployeeSalary john;
	private EmployeeSalary mary;
	private final static double TOLERANCE = 0.0001;

	@Before
	public void setup() {
		john = new EmployeeSalary("John Smith", 15000, 20);
		mary = new EmployeeSalary("Mary Jones", 23540, 45);
	}
